...
export function CoreTeamHeroSection() {
  return (
    <section
      aria-labelledby="core-team-hero-heading"
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-20 right-1/4 w-72 h-72 rounded-full bg-white/[0.08] blur-3xl"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-20 left-1/4 w-72 h-72 rounded-full bg-impact-green/[0.12] blur-3xl"
      />
      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          >
            The People Guiding Our Purpose
          </h1>

          {/* Description */}
          <p className="text-sm sm:text-base md:text-lg text-pure-white/90 leading-relaxed max-w-3xl mx-auto">
            Meet the dedicated leaders, professionals, coordinators, and
            advisors who guide UDBHAV Foundation with compassion, integrity,
            experience, and a shared commitment to meaningful community impact.
          </p>
        </div>
      </Container>
    </section>
...
export default CoreTeamHeroSection;
