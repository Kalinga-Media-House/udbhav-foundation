...
export function EventForm({ initialData, programs }: EventFormProps) {
  ...
  const [formData, setFormData] = useState<Partial<CreateEventDTO>>({
    ...
    registration_deadline: initialMetadata.registration_deadline
      ? new Date(initialMetadata.registration_deadline).toISOString().slice(0, 16)
      : '',
  });
  ...
  return (
    ...
    >
      ...
      {/* CLASSIFICATION */}
      <h3 className="border-b pb-2 pt-4 text-lg font-semibold">Classification</h3>
      ...
      {/* TIMING & REGISTRATION */}
      <h3 className="border-b pb-2 pt-4 text-lg font-semibold">Timing & Registration</h3>
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            value={(formData.registration_deadline as string) || ''}
            onChange={handleChange}
          />
        </div>
        <div className="space-y-2">
      ...
      {/* LOCATION & VENUE */}
      <h3 className="border-b pb-2 pt-4 text-lg font-semibold">Location & Virtual</h3>
      ...
      {formData.is_virtual && (
        <div className="mb-4 space-y-2">
          ...
          <Input
            ...
            id="virtual_link"
            name="virtual_link"
            value={formData.virtual_link as string}
            onChange={handleChange}
      ...
      {/* MEDIA */}
      <h3 className="border-b pb-2 pt-4 text-lg font-semibold">Media</h3>
      <div className="mb-4 space-y-2">
        <Label htmlFor="cover_image">Cover Image Upload</Label>
        <ImageUploader folder="events" onUploadComplete={handleUploadComplete} />
