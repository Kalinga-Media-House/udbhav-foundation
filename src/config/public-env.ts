...
export const publicEnvSchema = z.object({
  NEXT_PUBLIC_APP_URL: z.string().url("Must be a valid absolute URL. Example: http://localhost:3000"),
  NEXT_PUBLIC_SUPABASE_URL: z.string().url("Must be a valid Supabase project URL."),
  NEXT_PUBLIC_SUPABASE_ANON_KEY: z.string().min(32, "Supabase Anon Key is required and must be valid."),
